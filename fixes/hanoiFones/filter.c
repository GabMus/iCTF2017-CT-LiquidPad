...
int main(int argc, char **argv){
	...
	if( (pid = fork()) == 0 ){	//sono il processo figlio
		...
		while(quit){
			...
			buff[rd+1] = '\0';
			//printf("Padre: %s",buff);
			if(strstr(buff,"4200035") != NULL){
				printf("AH! Volevi\n");
				return 0;
			}
			if(strstr(buff,"4199686") != NULL){
				printf("AH! Volevi\n");
				return 0;
			}
			if(strstr(buff,"4196496") != NULL){
				printf("AH! Volevi\n");
				return 0;
			}
			if(strstr(buff,"629968") != NULL){
				printf("AH! Volevi\n");
				return 0;
			}
			...
			if(strstr(buff,"\\bin\\bash") != NULL){
				printf("AH! Volevi\n");
				return 0;
			}
			if(strstr(buff,"\\bin\\sh") != NULL){
				printf("AH! Volevi\n");
				return 0;
			}
			write(fd[1],buff,rd);
